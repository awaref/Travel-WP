...
if ( ! function_exists( 'trav_enqueue_scripts' ) ) {
	function trav_enqueue_scripts() {
		...
		if ( ! empty( $trav_options['map_api_key'] ) ) { 
			wp_register_script( 'trav_script_google_map', 'https://maps.googleapis.com/maps/api/js?key=' . $trav_options['map_api_key'], array(), '3.0', true );
		} else { 
...
if ( ! function_exists( 'trav_google_map_url' ) ) { 
	function trav_google_map_url( $map_url ) { 
		...
		if ( ! empty( $trav_options['map_api_key'] ) ) { 
			$map_url = 'https://maps.googleapis.com/maps/api/js?key=' . $trav_options['map_api_key'];
		}
		return $map_url;
	}
}